...
class FundraiserFragment extends StatefulWidget {
  @override
  _FundraiserFragmentState createState() => _FundraiserFragmentState();
}

class _FundraiserFragmentState extends State<FundraiserFragment>
  ...
  void initState() {
    ...
    _viewAllItemsBloc.getItems(false, true);
  }
    ...
    if (_itemsScrollController.offset >=
      ...
      if (_viewAllItemsBloc.hasNextPage) {
        Future.delayed(const Duration(milliseconds: 1000), () {
          _viewAllItemsBloc.getItems(true, true);
        });
      }
    }
    if (_itemsScrollController.offset <=
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      onRefresh: () {
        return _viewAllItemsBloc.getItems(false, true);
      },
      child: Container(
  ...
  void _errorWidgetFunction() {
    if (_viewAllItemsBloc != null) _viewAllItemsBloc.getItems(false, true);
  }
